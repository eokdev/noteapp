...
class DatePickers extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _DatePickersState();
}
            ...
            return InkWell(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    width: 1,
                    color: getBorderColor(isSelected, darkMode),
                  ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        DateFormat("MMM", widget.locale).format(date).toUpperCase(), // Month
                      ...
                      Text(
                        DateFormat("E", widget.locale).format(date).toUpperCase(), // WeekDay
                        style: genStyle(ref).copyWith(
                          color: getDateTimeLineColor(
                            isSelected,
                            darkMode,
...
class DatePickerController {
  _DatePickersState? _datePickerState;

  void setDatePickerState(_DatePickersState state) {
  ...
  double _calculateDateOffset(DateTime date) {
    final startDate =
        DateTime(_datePickerState!.widget.startDate.year, _datePickerState!.widget.startDate.month, _datePickerState!.widget.startDate.day);
